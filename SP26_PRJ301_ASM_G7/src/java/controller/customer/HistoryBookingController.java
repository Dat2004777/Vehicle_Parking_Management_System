 ...
 * @author ADMIN
 */
@WebServlet(name="HistoryBookingController", urlPatterns={"/customer-info/history-bookings"})
public class HistoryBookingController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<HistoryBookingDTO> histories = bookingDAO.getAllHistoryBooking(customer.getCustomerId());
        
        request.setAttribute("histories", histories);
        request.getRequestDispatcher("/WEB-INF/views/customer/history-bookings.jsp").forward(request, response);
    } 
