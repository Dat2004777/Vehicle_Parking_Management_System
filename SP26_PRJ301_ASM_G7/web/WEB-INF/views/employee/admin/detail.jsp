        ...
        <main class="main-content">
            ...
            <div class="content-area">
                ...
                <div class="page-header">
                    ...
                    <p class="page-subtitle">Vui lòng điền đầy đủ thông tin để cập nhật tài khoản nhân viên trong hệ thống.</p>
                </div>

                <form action="${ctx}/employee/detail" method="POST">
                    <input name="employeeId" id="employeeId" type="hidden" value="${not empty employee.employeeId ? employee.employeeId : employeeId}"/>
                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="row g-3">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <input value="${not empty employee.lastName ? employee.lastName : lastName}" type="text" name="lastName" class="form-control" placeholder="Nguyễn Văn" required>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <label class="form-label">Tên</label>
                                        <input value="${not empty employee.firstName ? employee.firstName : firstName}" type="text" name="firstName" class="form-control" placeholder="An" required>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <label class="form-label">Số điện thoại</label>
                                        <input value="${not empty employee.phone ? employee.phone : phone}" type="tel" name="phone" class="form-control" placeholder="0901 234 567" required>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <select name="siteId" class="form-select">
                                            ...
                                            <c:forEach var="site" items="${listSites}">
                                                <option value="${site.siteId}" ${site.siteId == employee.siteId ? 'selected' : ''}>${site.siteName}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
